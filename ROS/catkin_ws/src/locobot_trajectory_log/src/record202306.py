...
class Record():
	def __init__(self,datetime_now,fps):
	...
	def writer_joint_csv(self, path, file_name, data, ti):
		...
		self.joint_list = []
		self.joint_list.append(self.dic)
	...
	def cb_timer(self,event):
		...
		if self.trigger:
			# self.draw_path(time)
			log_path = os.path.join(self.path, "log_"+self.datetime_now)
...
if __name__ == '__main__':
    ...
    Recoder = Record(datetime_now, fps)
